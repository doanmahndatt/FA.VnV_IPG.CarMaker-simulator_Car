...
static const char *CompileLibs[] = {
    ...
    "libcar4sl.a	CarMaker-Car win64 15.1 2026-05-05",
    "libcarmaker4sl.a	CarMaker win64 15.1 2026-05-05",
    "libipgdriver.a	IPGDriver win64 15.1.0.3 2026-04-28",
    "libipgroad.a	IPGRoad win64 15.1 2026-04-30",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=150100",
    "-DMYMODELS -Wall -D__USE_MINGW_ANSI_STDIO -DUNICODE",
    "-DCM4SL -U__STRICT_ANSI__ -Wall -malign-double",
    "-fomit-frame-pointer",
    "-I../../../lib/IPGIpcApi/win64/include/IPGIpcApi",
    NULL
};
...
tAppStartInfo   AppStartInfo = {
    ...
    "16d9601a3450",         /* App_CompileSystem   */
    "2026-05-05 10:47:28",  /* App_CompileTime */
